...
const boardContainer = document.getElementById("game-board") as HTMLDivElement;
const boardSizeInput = document.getElementById("board-size") as HTMLInputElement;
const boardSizeText = document.getElementById("sizeLabel") as HTMLInputElement;
...
export default function drawBoard(board: Dot[][]) {
    // clear the board
