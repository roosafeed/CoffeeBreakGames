...
function playerMoveRight() {
    ...
    if (!isGameRunning())
        return;
    (_a = gameState.player) === null || _a === void 0 ? void 0 : _a.moveRight();
}
function playerMoveLeft() {
    var _a;
    if (!isGameRunning())
        return;
    (_a = gameState.player) === null || _a === void 0 ? void 0 : _a.moveLeft();
}
function resetGame() {
...
function spawnAsteroid() {
    ...
    if (((_a = gameState.asteroids) === null || _a === void 0 ? void 0 : _a.length) >= requiredCount)
        return;
    ...
    (_b = gameState.asteroids) === null || _b === void 0 ? void 0 : _b.push(asteroid);
}
function getRequiredAsteroidCount() {
    const baseCount = 3;
    const maxCount = 10;
...
function detectCollisions(asteroid) {
    if (!isGameRunning() || !gameState.player || !asteroid)
        return false;
 ...
 */
function distPointToEdge(px, py, x1, y1, x2, y2) {
